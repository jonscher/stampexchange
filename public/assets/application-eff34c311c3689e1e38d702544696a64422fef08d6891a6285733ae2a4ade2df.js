...
(function() {
  ...
  TwitterBootstrapConfirmBox = function(message, element, callback) {
    ...
    return $dialog.find(".modal-header").find(".modal-title").html(element.data("confirm-title") || $.fn.twitter_bootstrap_confirmbox.defaults.title).end().end().find(".modal-body").html(message.toString().replace(/\n/g, "<br />")).end().find(".modal-footer").append($("<a />", {
      href: "#",
      "data-dismiss": "modal"
